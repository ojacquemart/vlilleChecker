...
public class BalloonOverlayView<Item extends OverlayItem> extends FrameLayout {
	...
	public BalloonOverlayView(final Context context, int offset) {
		...
		mFavoriteCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton checkBox, boolean checked) {
				if (mStationId != null) {
					ApplicationContextHelper.registerPrefsStation(context, mStationId.toString(), checked);
				}
			}
		});
	...
	public void setData(MyOverlayItem item, Location location) {
		...
		mFavoriteCheckBox.setChecked(ApplicationContextHelper.isStarred(mContext, station.getId()));
		// mId = String
