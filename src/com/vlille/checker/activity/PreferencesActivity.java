...
/**
 * Preferences Vlille checker activity.
 */
public class PreferencesActivity extends VlilleListActivity {
	...
	private void setAdapter(List<Station> stations) {
		setListAdapter(new PreferencesAdapter(this, R.layout.preferences_details, stations));
	}
